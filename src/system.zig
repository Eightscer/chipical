...
const font_loc = [16]u12{ 0x1DC, 0x1B7, 0x1C7, 0x1CB, 0x1C2, 0x1CF, 0x1D3, 0x1D7, 0x1E0, 0x1E2, 0x1E6, 0x1EB, 0x1F4, 0x1EF, 0x1F9, 0x1FB };
...
pub fn init_prng(c8: *Self) !void {
    c8.prng = std.Random.DefaultPrng.init(0x0123456789ab);
}
...
pub fn load_rom_file(self: *Self, path: []const u8) !void {
    ...
    const f = std.fs.cwd().openFile(path, .{ .mode = .read_only }) catch {
